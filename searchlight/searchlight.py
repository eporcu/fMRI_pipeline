...
"""
Basic searchlight, it leverages on scikit-learn
for crossvalidation and estimator choice
TODO: 
1. Handle spheres with zeros/no signal
2. Allow different sphere shapes
3. allow different metrics and extraction of confusion matrix 
   for each sphere
"""
...
class Searchlight:
    ...
    def sphere(self, center):
        ...
        mask_coord : 3D numpy array, binary mask array
